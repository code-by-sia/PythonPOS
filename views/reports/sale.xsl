	   	 ...
	   	 <div class="ReprotHeader">
             <img src="/static/uploads/logo.svg" class="logo"/>
		   	 ...
		   	 <span style="float:left;" >
	 	   	 ...
	 	   	 <span style="float:right;" >{{#_}}Sale Report{{/_}}</span>
	   	 </div>
         <table cellspacing="0" cellpadding="0" class="rep-table" >
             <tbody>
                 <tr>
                    ...
                    <td>{{#_}}Customer{{/_}}</td>
                    <td><xsl:value-of select="../Header/CustomerName"/></td>
                    <td>{{#_}}User{{/_}}</td>
	   	 ...
	   	 <table cellspacing="0" cellpadding="0" class="rep-table alt" >
	   	 	...
	   	 	<tbody>
	   	 		<xsl:for-each select="Row" >
		              ...
		              <td class="price" ><xsl:value-of select="StorageName" /></td>
